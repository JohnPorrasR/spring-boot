...
import com.johnporrasr.demo3.service.IClienteService;
import com.johnporrasr.demo3.util.PageRender;
...
public class ClienteController {
	...
	public String editar(@PathVariable(value = "id") Long id, Map<String, Object> model, RedirectAttributes flash) {
		...
		if (id > 0) {
			flash.addFlashAttribute("error", "El codigo del cliente debe ser diferente a 0");
		...
		model.put("cliente", cliente);
		model.put("titulo", "Agregar nuevo cliente");
		flash.addFlashAttribute("info", "Actualizado datos del cliente");
		return "form";
